...
dia_menor = FOREACH agrupacion_promedio GENERATE promedio_genero, MAX(promedio_genero.promedio);

DUMP dia_menor;
STORE dia_menor INTO '/user/cpatin10/pig/outPeorPeliculaXGenero' USING PigStorage (',');
