...
dia1_menor = FOREACH agrupacion_conteo GENERATE conteo_peliculas, MIN(conteo_peliculas.conteo) as minimo;

dia_menor = FILTER dia1_menor BY conteo_peliculas.conteo == minimo;
