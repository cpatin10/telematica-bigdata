...
dia_menor = FOREACH agrupacion_promedio GENERATE promedio_calificacion, MAX(promedio_calificacion.promedio);
DUMP dia_menor;
STORE dia_menor INTO '/user/cpatin10/pig/outDiaMayorEvaluacion' USING PigStorage (',');
